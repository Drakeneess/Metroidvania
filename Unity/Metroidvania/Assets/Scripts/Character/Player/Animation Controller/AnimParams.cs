...
public static class AnimParams
{
    ...
    public static readonly int TrigHit     = Animator.StringToHash("isTakingDamage");
    public static readonly int TrigDie     = Animator.StringToHash("isDying");
    public static readonly int TrigClimb   = Animator.StringToHash("isClimbing");
